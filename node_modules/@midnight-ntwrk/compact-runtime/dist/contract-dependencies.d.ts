 ...
 * the dependency set.
 */
export declare type SparseCompactContractAddress = {
    tag: 'contractAddress';
};
/**
 * A data structure indicating the locations of contract references in a Compact struct.
 */
export declare type SparseCompactStruct = {
    tag: 'struct';
    /**
 ...
 */
export declare type SparseCompactVector = {
    tag: 'vector';
    /**
 ...
 * a contract address.
 */
export declare type SparseCompactType = SparseCompactVector | SparseCompactStruct | SparseCompactContractAddress;
/**
 * A data structure indicating the locations of all contract references in a Compact value.
 */
export declare type SparseCompactValue = {
    tag: 'compactValue';
    /**
 ...
 */
export declare type SparseCompactCellADT = {
    tag: 'cell';
    /**
 ...
 */
export declare type SparseCompactSetADT = {
    tag: 'set';
    /**
 ...
 */
export declare type SparseCompactListADT = {
    tag: 'list';
    /**
 ...
 */
export declare type SparseCompactArrayLikeADT = SparseCompactSetADT | SparseCompactListADT;
/**
 * A data structure indicating the locations of all contract references in a Compact `Map` ADT.
 */
export declare type SparseCompactMapADT = {
    tag: 'map';
    /**
 ...
 */
export declare type SparseCompactADT = SparseCompactCellADT | SparseCompactArrayLikeADT | SparseCompactMapADT;
/**
 * A data structure indicating the locations of all contract references in a given ledger state.
 */
export declare type PublicLedgerSegments = {
 ...
 */
export declare type EmptyPublicLedger = {
    tag: 'publicLedgerArray';
    indices: undefined;
};
/**
 ...
 */
export declare type ContractReferenceLocations = EmptyPublicLedger | PublicLedgerSegments;
/**
